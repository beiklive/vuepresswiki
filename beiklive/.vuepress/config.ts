/**
 * 提示：如您想使用JS版本的配置文件可参考：https://github.com/beiklive/vuepress-theme-vdoing/tree/a2f03e993dd2f2a3afdc57cf72adfc6f1b6b0c32/docs/.vuepress
 */
...
const DOMAIN_NAME = 'beiklive.top' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '学习',
        link: '/learn/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
        items: [
      ...
      },
      {
        ...
        link: '/resource/',
        items: [
          { text: '技术文档', link: '/pages/622949/' },
          { text: '工具网站', link: '/pages/aaae5a/' },
          { text: 'Github项目', link: '/pages/d4c1f1/' }
        ],
      },
      {
        text: '更多',
    ...
    //*** 以下是Vdoing主题相关配置，文档：https://doc.beiklive.com/pages/a20ce8/ ***//
    ...
    // bodyBgImg: [
    //   'https://jsd.cdn.zzko.cn/gh/beiklive/image_store/blog/20200507175828.jpeg',
    //   'https://jsd.cdn.zzko.cn/gh/beiklive/image_store/blog/20200507175845.jpeg',
    //   'https://jsd.cdn.zzko.cn/gh/beiklive/image_store/blog/20200507175846.jpeg'
    ...
    author: {
      name: 'beiklive', // 必需
      link: 'https://github.com/beiklive', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://beiklive-picbed-1-1306865739.cos.ap-nanjing.myqcloud.com/imgSource/c70e6188-0562-4d88-9768-931a9b2cb555.png',
      name: 'beiklive',
      slogan: '全沾艺人',
    },

    // 社交图标 (显示于博主信息栏和页脚栏。内置图标：https://doc.beiklive.com/pages/a20ce8/#social)
    social: {
